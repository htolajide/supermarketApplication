   ...
   for(i=1; i<3; i++){ document.image_rotate.src = myimages[number];
     ...
     if (number > 3) number=1;
             ...
             <img name="image_rotate" src="../../images/verologo00.png" onLoad="setTimeout('animate()', delay);" alt="verologo" />
                    ...
                    <nav class="main-nav">
                        <ul>
                            <li><a class="active" href="."><?php echo $title; ?></a></li>
            ...
            <div class="container">                
             ...
             <h5>Enter Date: <form action="" method="post" >          
    <input type="text"  class ="custominput" name="tdate" placeholder="YYYY-MM-DD" >
    <input class="btn btn-sm btn-primary" type="submit" name="action"   value="<?php echo $search; ?>">
    </form></h5>
...
<thead>
 <tr>
  ...
  <tbody>
      <?php $sn_count = 1;
      if ( $transacts == '' ){ echo '<tr><td>No Record Found</td></tr>';} foreach ($transacts as $transact): ?>
 
      <tr>
      <td><?php htmlout($sn_count); ?></td>
      <td><?php htmlout($transact['customername']); ?></td>
      <td>#<?php htmlout($transact['id']); ?></td>
      <td> 
      <div class="listuser">
           <form action="" method="post" >
             <input type="hidden" name="transactionid" value="<?php htmlout($transact['transactionnumber']); ?>">
