   ...
   for(i=1; i<3; i++){ document.image_rotate.src = myimages[number];
     ...
     if (number > 3) number=1;
             ...
             <img name="image_rotate" src="../../images/verologo00.png" onLoad="setTimeout('animate()', delay);" alt="verologo" />
                    ...
                    <nav class="main-nav">
                       <ul> <li><a class="active" href=".">Cash Receipt</a></li>
               ...
               <div class="pull-left">
                ...
                <div class="pull-right">
				 <h5><?php
                    ...
                    <h5><?php echo 'Branch: ';
                     htmlout($_SESSION['branchname']); ?></h5>
...
<tr>
<td>Total:</td>
<td colspan=3><?php htmlout($_SESSION['payment']);?></td>
<td>&#8358;<?php echo number_format($total, 2); ?></td>
</tr>
</tfoot>
  <tbody>
      <?php foreach ($cart as $sales): ?>
 
      <tr>
      <td>#<?php htmlout($sales['receiptno']); ?></td>
      <td><?php htmlout($sales['brandname']); 
      echo ' ';
      htmlout($sales['productname']);
      echo ' ';
      htmlout($sales['categoryname']); ?></td>
      <td><?php htmlout($sales['unitprice']); ?></td>
      <td><?php htmlout($sales['quantity']); ?></td>
      <td><?php htmlout($sales['total']); ?></td>
    </form>
    </tr>
      ...
      <?php endforeach; ?>
		...
		<?php endif; ?>
		<H4>Goods bought in good condition are not returnable. Thanks<br><?php $today=new DateTime;
