...
<html>
    ...
    <![endif]-->
		...
		$(function() {
			...
			$('#validationDefault07').datepicker('option', 'dateFormat', 'yy-mm-dd');
...
var number;
  ...
  function animate(){
   ...
   for(i=1; i<3; i++){ document.image_rotate.src = myimages[number];
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="text" name="quantity" class="form-control" id="validationDefault02" placeholder="Quantity" value="<?php htmlout($quantity); ?>" required>
    </div>
  </div>
    <div class="row">
    <div class="col-md-3 mb-3">
  ...
  <div class="row">
    ...
    <div class="col-md-3 mb-3">
        ...
        <select name="branches" id="inputState" class="form-control md-3" height="50px" >
          <option value="">Select one</option>
      ...
      <input type="text" name="productdate" class="form-control" id="validationDefault07" value="<?php htmlout($productdate); ?>" placeholder="Date" > 
        ...
        <div class="col-md-3 mb-3">
        <input class="btn btn-primary form-control md-3" type="submit" value="<?php htmlout($button); ?>">
        </div>
      </fieldset>
        </div>
      <div>
